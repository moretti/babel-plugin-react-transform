...
exports.default = function (_ref) {
  ...
  var componentVisitor = {
    Class: function Class(path) {
      ...
      var componentId = toComponentId(componentName);
      ...
      if (isStatement) {
        ...
        wrapped = t.variableDeclaration('const', [t.variableDeclarator(t.identifier(componentName), wrapped)]);
      }
